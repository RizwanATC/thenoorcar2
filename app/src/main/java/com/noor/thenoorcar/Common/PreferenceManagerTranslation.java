...
public class PreferenceManagerTranslation {
    SharedPreferences pref;
    SharedPreferences.Editor editor;
    Context _context;
    int PRIVATE_MODE = 0;
    private static final String PREF_NAME = "TheNoorTranslation";
    private static final String IS_LOGIN = "IsLoggedIn";
    public static final String KEY_THEME_ID = "key";
    public static final String KEY_THEME_NAME = "name";
    public static final String KEY_THEME_IMAGE = "code";

    public PreferenceManagerTranslation(Context context){
